...
// MustEmbedUnimplementedLedgerServiceServer implements the required gRPC method
func (s *LedgerGRPCService) MustEmbedUnimplementedLedgerServiceServer() {
    // This method is required by the gRPC interface but doesn't need implementation
}
